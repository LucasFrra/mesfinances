...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!token) {
        setInfoMsg("Please check your email to confirm your account.");
  ...
  if (showConfirmationScreen) {
    return (
      <section className="bg-muted h-screen w-screen flex items-center justify-center">
        <div className="bg-background border border-muted rounded-md shadow-md p-8 text-center max-w-md">
              ...
              {infoMsg && (
                <div className="bg-blue-50 border border-blue-200 rounded-md p-3 text-center">
                  <p className="text-blue-600 text-sm">
                    Account created!
                    <br />
                    Please check your email <b>{email}</b> to activate your
                    account.
                    <br />
